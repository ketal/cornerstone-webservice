...
@Provider
public class JavaLangErrorMapper extends AbstractExceptionMapper<Error> {

    private static final Logger logger = LogManager.getLogger(JavaLangErrorMapper.class);
    ...
    protected WsError getWsError() {
        ...
        logger.warn("Exception caught by JavaLangErrorMapper. ReferenceNumber: " + error.getReferenceId(), this.exception);
        return error;
    }
